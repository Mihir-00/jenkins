pipeline {
    ...
    environment {
        ...
        AMI_ID = 'ami-09a9858973b288bdd'  // Change to a valid Ubuntu AMI ID for your region
        KEY_NAME = 'mihir-devops'  // Replace with your AWS key pair name
        SECURITY_GROUP = 'sg-02474d371db7ea47a'  // Replace with your security group ID
        SUBNET_ID = 'subnet-0a0396533673372e1'  // Replace with your subnet ID
        GITHUB_REPO = 'https://github.com/Mihir-00/jenkins.git'
    }
